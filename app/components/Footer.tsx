        ...
        <footer className="w-full bg-neutral-900 text-neutral-400 py-12 px-6 md:px-12 border-t border-neutral-800">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
                <div className="col-span-1 md:col-span-2">
                    <Link href="/" className="text-white text-lg font-bold tracking-tight block mb-4">
                        lyf proyectos
                    </Link>
                ...
                <div>
                    <h3 className="text-white text-xs uppercase tracking-wider mb-4 font-mono">Sitemap</h3>
                ...
                <div>
                    <h3 className="text-white text-xs uppercase tracking-wider mb-4 font-mono">Social</h3>
            ...
            <div className="max-w-7xl mx-auto mt-12 pt-8 border-t border-neutral-800 flex flex-col md:flex-row justify-between items-center text-xs">
